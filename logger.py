...
class CsvLogger:
    ...
    def plot_progress_errk(self, claimed_acc=None, title='Net', k=1):
    ...
    def plot_progress_loss(self, title='Net'):
        plt.figure(figsize=(9, 8), dpi=300)
    ...
    def plot_progress(self, claimed_acc1=None, claimed_acc5=None, title='Net'):
